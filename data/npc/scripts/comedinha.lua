...
local bless_node = keywordHandler:addKeyword({'wisdom of solitude'}, playerBuyBlessNPC, {cost = 5000, items = 0, bless = 11262})
    bless_node:addChildKeywordNode(yesNode)
    bless_node:addChildKeywordNode(noNode)
local bless_node = keywordHandler:addKeyword({'spark of the phoenix'}, playerBuyBlessNPC, {cost = 5000, items = 0, bless = 11258})
    bless_node:addChildKeywordNode(yesNode)
    bless_node:addChildKeywordNode(noNode)
local bless_node = keywordHandler:addKeyword({'fire of the suns'}, playerBuyBlessNPC, {cost = 5000, items = 0, bless = 11261})
    bless_node:addChildKeywordNode(yesNode)
    bless_node:addChildKeywordNode(noNode)
local bless_node = keywordHandler:addKeyword({'spiritual shielding'}, playerBuyBlessNPC, {cost = 5000, items = 0, bless = 11260})
    bless_node:addChildKeywordNode(yesNode)
    bless_node:addChildKeywordNode(noNode)
local bless_node = keywordHandler:addKeyword({'embrace of tibia'}, playerBuyBlessNPC, {cost = 5000, items = 0, bless = 11259})
    bless_node:addChildKeywordNode(yesNode)
    bless_node:addChildKeywordNode(noNode)
